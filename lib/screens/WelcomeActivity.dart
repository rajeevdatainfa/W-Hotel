...
class WelcomeActivity extends StatefulWidget {
  ...
  @override
  WelcomeActivityView createState() =>WelcomeActivityView();
}

class WelcomeActivityView extends State<WelcomeActivity> {
  ...
  String url="https://wdoha-docs.s3.ap-south-1.amazonaws.com/1666023644968-Arrival_Experience_in_Qatar_14.09.pdf";
  String tName="";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Welcome Pack", style: TextStyle(fontSize: 20.0, color: Colors.white),),
        toolbarHeight: 70,
      ),
      body: SafeArea(
        child: Container(
