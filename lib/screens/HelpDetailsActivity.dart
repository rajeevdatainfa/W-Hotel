...
class HelpDetailsActivity extends StatefulWidget {

  String url="";
  String tName="";

  HelpDetailsActivity({Key? key, required this.url, required this.tName}) : super(key: key);

  @override
  HelpDetailsActivityView createState() =>HelpDetailsActivityView();
}

class HelpDetailsActivityView extends State<HelpDetailsActivity> {
