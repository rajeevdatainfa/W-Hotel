...
class BusDetailsActivity extends StatefulWidget {

  String url="";
  String tName="";

  BusDetailsActivity({Key? key, required this.url, required this.tName}) : super(key: key);

  @override
  BusDetailsActivityView createState() =>BusDetailsActivityView();
}

class BusDetailsActivityView extends State<BusDetailsActivity> {
