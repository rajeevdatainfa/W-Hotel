...
class RestaurentDetailsActivity extends StatefulWidget {

  String url="";
  String tName="";

  RestaurentDetailsActivity({Key? key, required this.url, required this.tName}) : super(key: key);

  @override
  RestaurentDetailsActivityView createState() =>RestaurentDetailsActivityView();
}

class RestaurentDetailsActivityView extends State<RestaurentDetailsActivity> {
